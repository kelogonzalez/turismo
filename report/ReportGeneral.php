...
while($DSAC=mysqli_fetch_array($SAC, MYSQLI_ASSOC)){
    ...
    if(mysqli_num_rows($SABC)>=1){
        ...
        $pdf->Cell (34,6,utf8_decode('EDICIÓN'),1,0,'C',true);
        ...
        while($DSABC=mysqli_fetch_array($SABC, MYSQLI_ASSOC)){
            ...
            $pdf->Cell (34,6,utf8_decode($DSABC['Edicion']),1,0,'C');
            $pdf->Cell (16,6,utf8_decode($dataInstitution['Moneda'].$DSABC['Estimado']),1,0,'C');
