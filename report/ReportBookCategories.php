...
while($datCat=mysqli_fetch_array($SelCat, MYSQLI_ASSOC)){
    ...
    $pdf->Cell (60,6,utf8_decode($datCat['Nombre']),1,0,'C');
    $pdf->Cell (20,6,utf8_decode($datCat['CodigoCategoria']),1,0,'C');
...
$pdf->SetFont("Times","b",10);
$pdf->Cell (80,6,utf8_decode('TOTAL DE EMPRESAS'),1,0,'C',true);
