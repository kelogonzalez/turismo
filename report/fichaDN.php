...
$pdf->Cell (30,5,utf8_decode('NIT Institución: '),0);
$pdf->SetFont("Times","",12);
$pdf->Cell (37,5,utf8_decode($dataInstitution['CodigoInfraestructura']),0);
$pdf->SetFont("Times","b",12);
...
$pdf->SetFont("Times","",12);
$pdf->Cell (25,5,utf8_decode($dataUser['DUI']),0);
$pdf->Ln(12);
$pdf->SetFont("Times","b",12);
...
$pdf->Ln(10);
$pdf->SetFont("Times","",12);
$pdf->Cell (0,10,utf8_decode('Código del libro: '.$dataBook['CodigoLibroManual'].''),1);
$pdf->Ln(10);
$pdf->Cell (0,10,utf8_decode('Título del libro: '.$dataBook['Titulo'].''),1);
$pdf->Ln(10);
$pdf->Cell (0,10,utf8_decode('Autor: '.$dataBook['Autor'].''),1);
$pdf->Ln(10);
$pdf->Cell (0,10,utf8_decode('Total libros prestados: '.$dataKey['Cantidad'].''),1);
$pdf->Ln(10);
