...
if(mysqli_num_rows($selectStudents)<=0){
    ...
    if($totalP<=0){
                ...
                if(consultasSQL::DeleteSQL("docente", "DUI='".$primaryKey."'")){
                    echo '<script type="text/javascript">
                        swal({
                            ...
                            text:"Todos los datos han sido eliminados del sistema exitosamente",
                            type: "success",
                    ...
                    echo '<script type="text/javascript">
                        swal({
                            ...
                            text:"No hemos podido eliminar los datos del personal, por favor intenta nuevamente",
                            type: "error",
                            confirmButtonText: "Aceptar"
                        });
                    </script>';
        ...
        echo '<script type="text/javascript">
            swal({
                title:"¡Ocurrió un error inesperado!",
                text:"El personal tiene préstamos pendientes, no se pueden borrar los datos del personal mientras no devuelva los libros", 
                type: "error",
                confirmButtonText: "Aceptar"
            });
        </script>';
