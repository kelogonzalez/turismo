...
if(mysqli_num_rows($checkBDRespon)>0){
    ...
    echo '
        ...
        <div class="group-material">
            <input type="text" class="material-control tooltips-general" placeholder="Teléfono" name="representativePhone" pattern="[0-9+]{5,20}" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="Solamente números y símbolo +">
            <span class="highlight"></span>
            <span class="bar"></span>
