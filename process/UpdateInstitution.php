...
$institutionCoin=consultasSQL::CleanStringText($_POST['institutionCoin']);
...
if(consultasSQL::UpdateSQL("institucion", "CodigoInfraestructura='$institutionCode',Nombre='$institutionName',NombreDirector='$institutionNameDirector',NombreBibliotecario='$institutionNameLibrarian',Moneda='$institutionCoin',Telefono='$institutionPhone',Year='$institutionYear'", "CodigoInfraestructura='$institutionCode'")){
