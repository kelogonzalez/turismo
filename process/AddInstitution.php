...
if(mysqli_num_rows($checkInstitution)<=0){
    if(consultasSQL::InsertSQL("institucion", "CodigoInfraestructura, Nombre, NombreDirector, NombreBibliotecario, Moneda, Telefono, Year", "'$institutionCode','$institutionName','$institutionNameDirector','$institutionNameLibrarian','$institutionCoin','$institutionPhone','$institutionYear'")){
