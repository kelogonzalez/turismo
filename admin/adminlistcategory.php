...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de las actividades de las empresas. Puedes actualizar o eliminar los datos de la actividad siempre y cuando no tenga empresas asociados.
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                      <li><a href="admincategory.php">Nueva actividad</a></li>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles">Lista de actividades</h2>
            <div class="div-table">
          ...
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../process/UpdateCategory.php" method="post" data-type-form="update" autocomplete="off">
              <div class="modal-header">
                ...
                <h4 class="modal-title text-center all-tittles">Actualizar datos de la actividad</h4>
              </div>
